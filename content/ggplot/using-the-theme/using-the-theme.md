...
introImage: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/chart-layout.svg"   
...
sections:
  ...
  - title: "Applying the theme `theme_capd()`"
    ...
    code: |
        gg_ex_bar  
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-4-1.svg" 
  ...
  - content: | 
    ...
    code: |  
      gg_ex_bar +
        theme_capd() 
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-5-1.svg" 
  ...
  - content: | 
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-6-1.svg" 
  ...
  - content: | 
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-8-1.svg"
    ...
    code: |  
      gg_ex_bar +
         ...
         theme_capd(grid_lines = c('major','minor'), 
                    ...
                    ticks = TRUE, 
                    legend_position = 'none')            
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-7-1.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-9-1.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-9-2.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-9-3.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-10-1.svg" 
    alt: "An image of a bar chart showing generation resource mix by fuel type built in ggplot with the custom theme_capd() theme applied. The background is white and the gridlines are horizontal and a dotted light gray. The default color scheme is still applied."
  - code: |  
      gg_ex_bar +
           theme_capd(axis_lines = 'vert')
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-10-2.svg" 
    alt: "An image of a bar chart showing generation resource mix by fuel type built in ggplot with the custom theme_capd() theme applied. The orientation of the axis and gridlines has now been changed to vertical to match the fact that this is a bar chart. The default color scheme is still applied."
  - code: |  
      gg_ex_bar +
            theme_capd(axis_lines = 'both')
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-10-3.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-11-1.svg" 
    alt: "An image of a bar chart showing generation resource mix by fuel type built in ggplot with the custom theme_capd() theme applied. The background is white and the gridlines are horizontal and a dotted light gray. The default color scheme is still applied."
  - code: |  
      gg_ex_bar +
          theme_capd(grid_lines = 'major', axis_lines = 'vert')
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-11-2.svg" 
    alt: "An image of a bar chart showing generation resource mix by fuel type built in ggplot with the custom theme_capd() theme applied. The orientation of the axis and gridlines has now been changed to vertical to match the fact that this is a bar chart. The default color scheme is still applied."
  - code: |  
      gg_ex_bar +
          theme_capd(grid_lines = c('major','minor'), axis_lines = 'vert')
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-11-3.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-11-4.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-12-1.svg" 
    alt: "An image of a bar chart showing generation resource mix by fuel type built in ggplot with the custom theme_capd() theme applied. The background is white and the gridlines are horizontal and a dotted light gray. The default color scheme is still applied."
  - code: |  
      gg_ex_bar +
          theme_capd(ticks = TRUE)
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-12-2.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-13-1.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-14-1.svg" 
  ...
  - code: |  
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-14-2.svg" 
  ...
  - code: |  
      gg_ex_bar +
          theme_capd(legend_position = 'bottom')
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-14-3.svg" 
  ...
  - title: "Sequential"
    level: 4
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-15-1.svg" 
  ...
  - title: "Divergent"
    level: 4
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-16-1.svg"
  ...
  - image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-17-1.svg" 
  ...
  - title: "Fuel type palettes"
    level: 5
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-18-1.svg"
  ...
  - content: | 
    ...
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/example-barcart.svg"
  ...
  - content: | 
    ...
    code: |
        ggplot(resource_mix,aes(x = year, y = generation_resource_mix*100, color = resource_label, group = resource_label)) +
          ...
          theme_capd(grid_lines = c('major','minor'))
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/example-line-plot.svg"
  ...
  - code: |  
      ggplot(combustion) +
        ...
        theme_capd(axis_lines = 'vert')
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-19-1.svg"
  ...
  - title: "Renewables vs Non-renewables"
    level: 5
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-20-1.svg"
  ...
  - code: |  
      ggplot(renewables) +
        ...
        theme_capd(axis_lines = 'vert')
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-21-1.svg"
  ...
  - title: "Pollutant palettes"
    level: 4
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-22-1.svg"
  ...
  - title: "Unordered palettes"
    level: 4
    image: "/power-sector-dev-portal/assets/images/ggplot/using-the-theme/unnamed-chunk-23-1.svg"
